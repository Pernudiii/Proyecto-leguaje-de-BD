...
-- 3. Tabla CATEGORIA
-- Secuencia para IDs de Categoría
...
-- Tabla CATEGORIA (Estructura Opción B)
CREATE TABLE FIDE_CATEGORIA_TB (
    id_categoria NUMBER NOT NULL,
    tipo VARCHAR2(20) NOT NULL, -- 'PLATILLO' o 'BEBIDA'
    nombre VARCHAR2(100) NOT NULL,
    descripcion VARCHAR2(255),        
    CONSTRAINT FIDE_CATEGORIA_PK PRIMARY KEY (id_categoria),
    CONSTRAINT FIDE_CATEGORIA_TIPO_CHK CHECK (tipo IN ('PLATILLO', 'BEBIDA')),
    CONSTRAINT FIDE_CATEGORIA_NOMBRE_UK UNIQUE (nombre, tipo) -- Nombre único por tipo
);
...
CREATE SEQUENCE FIDE_INSUMO_SEQ
 START WITH     1
 INCREMENT BY   1
 NOCACHE
 NOCYCLE;
...
CREATE TABLE FIDE_INSUMO_TB (
    ...
    id_categoria NUMBER,             
    CONSTRAINT FIDE_INSUMO_PK PRIMARY KEY (id_insumo),
    CONSTRAINT FIDE_INSUMO_CODIGO_UK UNIQUE (codigo),
    CONSTRAINT FIDE_INSUMO_CATEGORIA_FK FOREIGN KEY (id_categoria)
...
-- 18. Tabla PRODUCTO_INSUMO BORRADO
