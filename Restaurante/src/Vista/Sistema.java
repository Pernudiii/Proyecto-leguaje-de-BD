...
public final class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbCategoriaP = new javax.swing.JComboBox<>();
        ...
        jPanel11.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, -1, -1));
        ...
        jPanel11.add(txtPrecioPlato, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 110, 170, 30));
        ...
        jPanel11.add(jPanel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 170, 2));
        ...
        jPanel11.add(jPanel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, 170, 2));

        txtDescripcionPlato.setBackground(new java.awt.Color(204, 204, 204));
        txtDescripcionPlato.setBorder(null);
        txtDescripcionPlato.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtDescripcionPlatoKeyTyped(evt);
            }
        });
        jPanel11.add(txtDescripcionPlato, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 160, 170, 30));

        jLabel41.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        jLabel41.setText("Categoria:");
        jPanel11.add(jLabel41, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, -1, -1));

        cbCategoriaP.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Acompañamientos", "Classic Burgers", "Special Burgers", "Quesadillas", "Papas KO's", "Nachos KO's", "Bebidas" }));
        cbCategoriaP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbCategoriaPActionPerformed(evt);
            }
        });
        jPanel11.add(cbCategoriaP, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 220, 170, 30));
    ...
    private void btnGuardarPlatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarPlatoActionPerformed
        ...
        !"".equals(txtPrecioPlato.getText()) &&
        !"".equals(txtDescripcionPlato.getText()) &&
        cbCategoriaP.getSelectedItem() != null &&
        !"".equals(cbCategoriaP.getSelectedItem().toString())) {
                
            pla.setNombre(txtNombrePlato.getText());
            pla.setPrecio(Double.parseDouble(txtPrecioPlato.getText()));
            pla.setDescripcion(txtDescripcionPlato.getText());
            String[] categorias = {"Acompañamientos", "Classic Burgers", "Special Burgers", "Quesadillas", "Papas KO's", "Nachos KO's", "Bebidas"};
            int idCategoria = 0;
            String seleccionado = cbCategoriaP.getSelectedItem().toString();
            for (int i = 0; i < categorias.length; i++) {
                if (seleccionado.equals(categorias[i])) {
                    idCategoria = i + 1; // Se suma 1 porque los IDs comienzan en 1
                    break;
                }
            }
            pla.setId_categoria(idCategoria);
    ...
    private void txtDescripcionPlatoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescripcionPlatoKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txtDescripcionPlatoKeyTyped

    private void cbCategoriaPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbCategoriaPActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbCategoriaPActionPerformed
    ...
    private javax.swing.JComboBox<String> cbCategoriaP;
    ...
    private void ListarPlatos(JTable tabla) {
        ...
        Object[] ob = new Object[3];
        for (int i = 0; i < Listar.size(); i++) {
            ob[0] = Listar.get(i).getId_producto();
            ob[1] = Listar.get(i).getNombre();
